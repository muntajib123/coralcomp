...
const incidentData = [
  {
    ...
    date: "1st June 2009",
    reason: "Ice crystals obstructed the aircraft's pitot tubes causing autopilot to disconnect.",
    fatalities: 228,
    site: "Atlantic Ocean",
...
const IncidentCard = ({ incident }) => (
  <Card sx={{ width: 300, mx: 2, borderRadius: 2, boxShadow: 3 }}>
    ...
    <CardContent>
      ...
      <Typography variant="body2"><strong>Reason:</strong> {incident.reason}</Typography>
      <Typography variant="body2"><strong>Fatalities:</strong> {incident.fatalities}</Typography>
      <Typography variant="body2"><strong>Location:</strong> {incident.site}</Typography>
    </CardContent>
...
const IncidentCarousel = () => {
  ...
  return (
    <Box sx={{ width: '100%', overflow: 'hidden', py: 6 }}>
      ...
      >
        Air crashes due to extreme weather conditions
      </Typography>
